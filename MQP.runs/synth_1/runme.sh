...
HD_PWD='C:/Users/mtlun/Documents/MQP/MQP/MQP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exhaustive_search.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exhaustive_search.tcl
