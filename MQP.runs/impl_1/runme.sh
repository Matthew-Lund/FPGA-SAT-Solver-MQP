...
HD_PWD='C:/Users/mtlun/Documents/MQP/MQP/MQP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exhaustive_search.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exhaustive_search.tcl -notrace
