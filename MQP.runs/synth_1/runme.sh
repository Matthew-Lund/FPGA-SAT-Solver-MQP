...
HD_PWD='C:/Users/Matthew/Documents/GitHub/FPGA-SAT-Solver-MQP/MQP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exhaustive_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exhaustive_Top.tcl
